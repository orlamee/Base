...
import hub from "../img/rhode.jpeg";
import work from "../img/h30.png";
import seedspace from "../img/debo.png";
  ...
  return (
    <div className="banner-section">
      ...
      <div className="banner-inner">
        <div
          className="row subtext justify-content-center"
          data-aos="slide-down"
          data-aos-duration="2000"
        >
          <div className="col-md-8 text-center">
            <h2 className="hero">
              <span style={{ color: "#00ABE7" }}>Work</span> from the
            </h2>
            <h2 className="hero">
              best <span id="spin"></span>
            </h2>
            {/* <Animation/> */}
            <h2 className="hero">in your city</h2>
            <h6 className="text-muted pt-4 fs-5">
              Ditch inconsistent power supply at home, check-in to a
            </h6>
            <h6 className="text-muted fs-5">
              workspace near you, pay per minute
            </h6>
            <GetStarted />
          </div>
        </div>
      ...
      <div className="container" data-aos="slide-left" data-aos-duration="2000">
        <div
          className="row justify-content-center desktop"
          style={{ marginTop: "-120px" }}
        >
          <div className="col-md-8 text-center">
            <h3 className="account">
              <span style={{ color: "#00ABE7" }}>1 account = </span>500+
              workspaces
            </h3>
          </div>
        </div>
        <div
          className="row justify-content-center mobile"
        ...
        <div className="row justify-content-center mt-5">
          <div className="col-md-5 mb-3">
            <div className="d-flex flex-row pin">
              <i
                className="fa fa-map-pin icon-hero me-3"
                aria-hidden="true"
              ></i>
          ...
          <div className="col-md-5">
            <div className="d-flex flex-row pin">
              <i
                className="fa fa-bullhorn icon-hero me-3"
                aria-hidden="true"
              ></i>
